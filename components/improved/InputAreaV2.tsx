      ...
      <form onSubmit={handleSubmit} className="flex gap-3">
        {mode === "keyword" ? (
          <input
            ...
            className="flex-1 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent"
          />
        ) : (
          <div className="flex items-center gap-3 flex-1">
            ...
            <input
              ...
              maxLength={7}
              placeholder="#6366f1"
              className="w-32 border border-gray-200 rounded-xl px-3 py-3 text-sm font-mono text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent"
        ...
        <button
          ...
          className="px-6 py-3 bg-indigo-600 text-white rounded-xl text-sm font-medium hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
        >
          {isLoading ? (
            <>
              <svg
